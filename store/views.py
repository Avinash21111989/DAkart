...
from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator  # paginator module
...
def product_detail(request,category_url, product_url):
  ...
  # return JsonResponse(single_product)
  # exit()
  return render(request, 'product-detail.html', context)

def search(request):
  # return HttpResponse('search')
  if 'keyword' in request.GET:  # 'keyword' = 'jeans' in request.GET
